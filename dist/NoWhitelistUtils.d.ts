...
export interface NoWhitelistUtilsInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "HALF_Q" | "Q" | "actionCnt" | "addNewContractAddress" | "collectionToContract" | "consumedActions" | "consumedConfigActions" | "contractToCollection" | "incrementor" | "pubKeyYParity" | "requireValidatorSig" | "setActionCnt" | "signingPubKeyX" | "validateTransferFees" | "validateUpdateGroupKey"): FunctionFragment;
...
export interface NoWhitelistUtils extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: NoWhitelistUtilsInterface;
