...
export class ERC1155Royalty__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(owner, overrides || {}) as Promise<ERC1155Royalty>;
  }
  ...
  override attach(address: string): ERC1155Royalty {
    return super.attach(address) as ERC1155Royalty;
  }
  override connect(signer: Signer): ERC1155Royalty__factory {
    return super.connect(signer) as ERC1155Royalty__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ERC1155RoyaltyInterface {
    return new utils.Interface(_abi) as ERC1155RoyaltyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ERC1155Royalty {
    return new Contract(address, _abi, signerOrProvider) as ERC1155Royalty;
  }
}
