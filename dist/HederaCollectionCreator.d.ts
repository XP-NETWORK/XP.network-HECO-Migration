...
export interface HederaCollectionCreatorInterface extends utils.Interface {
    functions: {
...
export interface HederaCollectionCreator extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HederaCollectionCreatorInterface;
